                ...
                <li class=""><a href="index.html">Home</a></li>              
                 <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="archive1.html">Debut Collection</a></li>
                    <li><a href="archive1.html">Enchanted Collection</a></li>                
                  </ul>
                </li>            
              ...
              <div class="latest_slider">
                ...
                <div class="slick_slider">
                  <div class="single_iteam">
                    <img src="img/devhill/550x330x1.jpg" alt="img">
                    <h2><a class="slider_tittle" href="single.html">Winter Collection</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="img/devhill/550x330x2.jpg" alt="img">
                    <h2><a class="slider_tittle" href="single.html">Winter Collection</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="img/devhill/550x330x3.jpg" alt="img">
                     <h2><a class="slider_tittle" href="single.html">Winter Collection</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="img/devhill/550x330x4.jpg" alt="img">
                     <h2><a class="slider_tittle" href="single.html">Winter Collection</a></h2>
                  </div>
                </div>
              </div>
            ...
            <div class="content_middle_leftbar">
              <div class="single_category wow fadeInDown">
                <h2>                  
                  ...
                  <a href="category-archive.html" class="title_text">category1</a>
                </h2>
                <ul class="catg1_nav">
                  <li>
                    <div class="catgimg_container">
                      <a href="single.html" class="catg1_img">
            ...
            <div class="content_middle_middle">
              <div class="slick_slider2">
                <div class="single_featured_slide">
                  <a href="single.html"><img src="img/devhill/567x330x1.jpg" alt="img"></a>
                  <h2><a href="single.html">Fashion trends</a></h2>
                  <p>Ways to wear. Make sure you shop smart for the season ahead.</p>
                </div>
                <div class="single_featured_slide">
                  <a href="single.html"><img src="img/devhill/567x330x2.jpg" alt="img"></a>
                  <h2><a href="#">Fashion trends 2</a></h2>
                  <p>Ways to wear. Make sure you shop smart for the season ahead.</p>
                </div>
                <div class="single_featured_slide">
                  <a href="single.html"><img src="img/devhill/567x330x3.jpg" alt="img"></a>
                  <h2><a href="#">Fashion trends 3</a></h2>
                  <p>Ways to wear. Make sure you shop smart for the season ahead.</p>
                </div>
              </div>
            </div>
            ...
            <div class="content_middle_rightbar">
               <div class="single_category wow fadeInDown">
                  <h2>                  
                    <span class="bold_line"><span></span></span>
                    <span class="solid_line"></span>
                    <a href="category-archive.html" class="title_text">category2</a>
                  </h2>
                  <ul class="catg1_nav">
                    <li>
                      <div class="catgimg_container">
              ...
              <div class="content_bottom_left">
                ...
                <div class="single_category wow fadeInDown">
                  <h2>                  
                    <span class="bold_line"><span></span></span>
                    <span class="solid_line"></span>
                    <a class="title_text" href="category-archive.html">Business</a>
                  </h2>
                  ...
                  <div class="games_category">
                    <div class="single_category">
                      <h2>                  
                        <span class="bold_line"><span></span></span>
                        <span class="solid_line"></span>
                        <a class="title_text" href="category-archive.html">Games</a>
                      </h2>
                    ...
                    <div class="single_category">
                      <div class="single_category wow fadeInDown">
                        <h2>                  
                          <span class="bold_line"><span></span></span>
                          <span class="solid_line"></span>
                          <a class="title_text" href="category-archive.html">Fashion</a>
                        </h2>
                        <ul class="fashion_catgnav wow fadeInDown">
                          <li>
                            <div class="catgimg2_container">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="single_footer_top wow fadeInLeft">
                <h2>Jackets Images</h2>
                <ul class="flicker_nav">
                  <li>
                      <a href="#"><img src="img/devhill/75x75x1.jpg" alt="img"></a>
                  </li>                 
                  <li>
                      <a href="#"><img src="img/devhill/75x75x2.jpg" alt="img"></a>
                  </li>
                   <li>
                      <a href="#"><img src="img/devhill/75x75x3.jpg" alt="img"></a>
                  </li>                 
                  <li>
                      <a href="#"><img src="img/devhill/75x75x4.jpg" alt="img"></a>
                  </li>
                   <li>
                      <a href="#"><img src="img/devhill/75x75x5.jpg" alt="img"></a>
                  </li>                 
                  <li>
                     <a href="#"><img src="img/devhill/75x75x6.jpg" alt="img"></a>
                  </li>
                   <li>
                      <a href="#"><img src="img/devhill/75x75x7.jpg" alt="img"></a>
                  </li>                 
                  <li>
                     <a href="#"><img src="img/devhill/75x75x8.jpg" alt="img"></a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="single_footer_top wow fadeInRight">
                <h2>Our Style</h2>
                <p>TIR Fashion House creates its unique designs using the “Ankara” fabric predominantly found in Western Africa. The designs are chic, trendy and often elaborately finished with embroidery, beads and lace. </p>
              </div>
            </div>
          </div>
        </div>
